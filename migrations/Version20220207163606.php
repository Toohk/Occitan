 ...
 */
final class Version20220207163606 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD COLUMN menu VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE __temp__dishe');
        $this->addSql('CREATE INDEX IDX_2AF53C6812469DE2 ON dishe (category_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__event AS SELECT id, name, description, date, picture, picture_desc FROM event');
        $this->addSql('DROP TABLE event');
        $this->addSql('CREATE TABLE event (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, date VARCHAR(255) DEFAULT NULL, picture VARCHAR(255) DEFAULT NULL, picture_desc VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO event (id, name, description, date, picture, picture_desc) SELECT id, name, description, date, picture, picture_desc FROM __temp__event');
