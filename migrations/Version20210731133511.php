 ...
 */
final class Version20210731133511 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE picture_menu (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, picture VARCHAR(255) NOT NULL)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE picture_menu');
        $this->addSql('DROP INDEX IDX_2AF53C6812469DE2');
        $this->addSql('CREATE TEMPORARY TABLE __temp__dishe AS SELECT id, category_id, name, description, price, picture FROM dishe');
        $this->addSql('DROP TABLE dishe');
